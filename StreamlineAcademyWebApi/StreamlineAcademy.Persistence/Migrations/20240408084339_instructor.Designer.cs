...
namespace StreamlineAcademy.Persistence.Migrations
{
    ...
    [Migration("20240408084339_instructor")]
            ...
            modelBuilder.Entity("StreamlineAcademy.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("73581fec-683f-472b-b802-1f9427183940"),
                            Address = "Hsr,Bangalore",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 4, 8, 14, 13, 38, 501, DateTimeKind.Unspecified).AddTicks(7288), new TimeSpan(0, 5, 30, 0, 0)),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Email = "aamir@anterntech.com",
                            IsActive = true,
                            ModifiedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ModifiedDate = new DateTimeOffset(new DateTime(2024, 4, 8, 14, 13, 38, 501, DateTimeKind.Unspecified).AddTicks(7362), new TimeSpan(0, 5, 30, 0, 0)),
                            Name = "amir",
                            Password = "MtRQAyZHnABddpdOTEO0flcAI0XReBCeHqfowr52Ulw=",
                            PhoneNumber = "8997654556",
                            PostalCode = "786545",
                            ResetCode = "",
                            Salt = "FmgUZoSkSbXL58nqMzmZjg==",
                            UserRole = (byte)1
                        });
                });
