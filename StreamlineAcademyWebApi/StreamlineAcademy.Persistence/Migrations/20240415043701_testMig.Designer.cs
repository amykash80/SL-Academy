...
namespace StreamlineAcademy.Persistence.Migrations
{
    ...
    [Migration("20240415043701_testMig")]
            ...
            modelBuilder.Entity("StreamlineAcademy.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("44e40b59-fcc2-4daf-8646-cf22464a48ca"),
                            Address = "Hsr,Bangalore",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 4, 15, 10, 6, 59, 691, DateTimeKind.Unspecified).AddTicks(2254), new TimeSpan(0, 5, 30, 0, 0)),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Email = "aamir@anterntech.com",
                            IsActive = true,
                            ModifiedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ModifiedDate = new DateTimeOffset(new DateTime(2024, 4, 15, 10, 6, 59, 691, DateTimeKind.Unspecified).AddTicks(2289), new TimeSpan(0, 5, 30, 0, 0)),
                            Name = "amir",
                            Password = "y6brZy8g4CqRZnKSbvJGFDbRfCiA+lrCO9MT4qaOSAw=",
                            PhoneNumber = "8997654556",
                            PostalCode = "786545",
                            ResetCode = "",
                            Salt = "Kb1I4Ri+F1a7lqVsQhoWsQ==",
                            UserRole = (byte)1
                        });
                });
