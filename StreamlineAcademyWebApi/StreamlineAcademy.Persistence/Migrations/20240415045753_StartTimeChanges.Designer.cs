...
namespace StreamlineAcademy.Persistence.Migrations
{
    ...
    [Migration("20240415045753_StartTimeChanges")]
    partial class StartTimeChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StreamlineAcademy.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("66bf7a81-730e-4b57-86c1-1f885734b717"),
                            Address = "Hsr,Bangalore",
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 4, 15, 10, 27, 52, 892, DateTimeKind.Unspecified).AddTicks(7725), new TimeSpan(0, 5, 30, 0, 0)),
                            DeletedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            Email = "aamir@anterntech.com",
                            IsActive = true,
                            ModifiedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            ModifiedDate = new DateTimeOffset(new DateTime(2024, 4, 15, 10, 27, 52, 892, DateTimeKind.Unspecified).AddTicks(7767), new TimeSpan(0, 5, 30, 0, 0)),
                            Name = "amir",
                            Password = "JFC8vDqxDFj2jDWOp/963eQ30d6b8Lv80kDQ27KxthM=",
                            PhoneNumber = "8997654556",
                            PostalCode = "786545",
                            ResetCode = "",
                            Salt = "xERJP+pg/FO+1F9H40Va3A==",
                            UserRole = (byte)1
                        });
                });
